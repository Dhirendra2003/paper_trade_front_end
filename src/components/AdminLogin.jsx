...
window.location.href='/adminhome'
  ...
  return (
    <div className='bg-black flex flex-col h-screen text-white  m-[auto] 
      ...
      <div className='  rounded-xl border-2 border-white/10 bg-white/[5%] p-5 backdrop-blur-lg w-96 mx-[auto] my-4'>
        <h1 className='text-[30px] text-fuchsia-200 text-center '>Admin Login</h1>

        <div className=' flex flex-col place-content-center mt-10'>
          <h2 className='text-xl pl-4'>Email</h2>
          <input id='mail' className='bg-black/50 text-xl p-1 w-80 rounded-xl m-2 text-center border-2 border-white/20' type="text" />
        </div>

        <div className=' flex flex-col place-content-center mt-2'>
          <h2 className='text-xl pl-4'>Password</h2>
          <input id='pass' className='bg-black/50 text-xl p-1 w-80 rounded-xl m-2 text-center border-2 border-white/20' type="password" />
        </div>
        <div className='m-[auto] grid place-content-center'>
          <button onClick={()=>{handlesubmit()}} type='submit' className='  py-1  rounded-xl bg-gradient-to-b from-cyan-500 to-violet-500 w-40 mx-2 mt-4 text-xl'>Login</button>
